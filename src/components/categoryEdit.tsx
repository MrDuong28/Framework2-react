...
import { formTypeC, Tcate } from "../interface/cate";
import { GetCategoryByID } from "../service/cate";
import {
  FaHome,
  FaProductHunt,
  FaPlus,
...
type Props = {
  onUpdate: (data: formTypeC, id: number | string) => void;
};

const EditCategory = ({ onUpdate }: Props) => {
  const {
    register,
    handleSubmit,
    reset,
  ...
  const onSubmitUpdateCate = async (category: formTypeC) => {
    await onUpdate(category, param.id as string | number);
      ...
      <div className="bg-gray-100">
        <div className="min-h-screen flex">
          ...
          <form
            ...
            onSubmit={handleSubmit(onSubmitUpdateCate)}
          >
            <div>
              <label
              ...
              <input
                ...
                {...register("name", {
                  ...
                  minLength: {
                    value: 6,
                    message: "Tên danh mục phải lớn hơn 6 ký tự",
                  },
                })}
